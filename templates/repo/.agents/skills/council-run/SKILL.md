---
name: council-run
description: Execute an approved council plan or task DAG through supervised workers. Use when Codex has an accepted design and needs to fan out bounded work, monitor progress, merge results, and report verification outcomes.
---
...
- Primary command shape: `node ~/.codex/skills/council/council.mjs run ...`.
- Use `claude-worker` for Claude-side supervised tasks from Codex.
