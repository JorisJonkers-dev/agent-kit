---
name: council-inject
description: Inject new constraints, evidence, files, or operator guidance into an active council flow. Use when Claude must add context to a run without restarting or rewriting unrelated plan artifacts.
---
...
- Primary command shape: `node ~/.claude/skills/council/council.mjs inject ...`.
