...
export const ARCHETYPE_CONTEXT_DEFAULTS = {
...
export const NAMED_CONTEXT_PROFILES = {
...
const DEFAULT_ARCHETYPE = 'implementer';
export function resolveContextProfile(request = {}) {
...
function isContextArchetype(value) {
...
function parseAxisEntry(key, value) {
    switch (key) {
        case 'workspace':
