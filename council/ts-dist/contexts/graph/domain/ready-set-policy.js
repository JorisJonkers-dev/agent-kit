...
export function dispatchReadySet(graph, limit = Number.POSITIVE_INFINITY) {
...
export function markTaskState(graph, id, state) {
...
export function propagateStalled(graph, stalledId) {
...
function dependsOnDependents(graph, id) {
    return graph.edges
