---
name: council-amend
description: Amend an existing council brief, design, task DAG, or run after user feedback, failed validation, changed constraints, or worker findings. Use when Claude must revise the plan without discarding useful completed work.
---
...
- Primary command shape: `node ~/.claude/skills/council/council.mjs amend ...`.
